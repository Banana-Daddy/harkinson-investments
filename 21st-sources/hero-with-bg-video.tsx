// Source: 21st.dev — "Hero with bg video" / "DarkProjectHero"
// Query used: "hero video editorial"
// Cached: 2026-04-26 for Harkinson Investment Corporation
// What we borrowed: full-bleed video bg + dark overlay pattern + centered content stack.
// We did NOT use the framer-motion animated word swap; we used a static editorial Fraunces headline
// over the timelapse video and added a vignette gradient instead of a flat 80% overlay.
  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-700 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 font-sans tracking-wide",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-black/70 text-red-300 border border-red-700 hover:bg-red-900/80 hover:text-white",
        outline: "border border-red-700 bg-transparent text-red-300 hover:bg-red-900/60 hover:text-white",
      },
      size: { default: "h-10 px-6 py-2", sm: "h-9 rounded-md px-4 text-sm", lg: "h-12 rounded-md px-10 text-lg", icon: "h-10 w-10" },
    },
